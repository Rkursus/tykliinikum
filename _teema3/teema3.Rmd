...
Impordime uuesti andmestiku, mida korra kasutasime ka eelmise teema all (Massachusettsi andmestik), ja vaatame andmestikust ülevaadet
```{r, results='hide'}
...
1. Moodusta alamandmestik, kuhu kuuluvad uuritavad, kelle kohta pole teada, kas nad on viimase aasta jooksul elukohta vahetanud (tunnus `MIG`). Kes sellesse andmestikku kuuluvad?
